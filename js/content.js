      ...
      tabs: [
        {
          ...
          blocks: [
            ...
            { type: 'tags', title: 'PM 视角看这段经历', items: [
              '需求拆解', '用户洞察', '数据驱动', 'SOP 沉淀'
            ]}
          ]
        },
        {
      ...
      tabs: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { type: 'paragraph', text:
              '每一单委托沟通都像一次高浓度的一对一访谈——很多线下委托人真正想要的其实是"男友皮"而不是严格还原的角色皮，' +
              '这个细节让我意识到，委托背后的深层诉求往往是渴望被认真对待的仪式感，而不是角色还原本身。这个判断不是来自某一个客户，' +
              '而是在几十次相似的沟通模式里反复验证出来的：表达方式各不相同，但底层诉求高度收敛。这也是我后来做用户研究习惯先问' +
              '"表面需求背后在意什么"的起点。' },
